...
import { PaymentComponent } from './userpage/cart/payment/payment.component';
import { OrdersummaryComponent } from './userpage/ordersummary/ordersummary.component';
...
@NgModule({
  ...
  providers: [UserService,AdminService,CartService,MedicineService,ContactService,BillingService],
